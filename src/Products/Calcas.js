...
return (
    ...
    <div>
        ...
        <div>
            <h6 className="navegacao">Página Inicial <span> {`>`} </span> <span className="spanRed">Calças</span></h6>
        </div>
        <div className="main d-flex flex-row">
            <div className="navbarLateral w-100 col-3 ">
    ...
    <nav aria-label="Page navigation example">
        <ul className="pagination justify-content-center">
            <li className="page-item">
                <Link className="page-link" to="/calcas" tabIndex="-1">{`<`}</Link>
            </li>
            <li className="page-item">
                <Link className="page-link" to="/calcas">1</Link>
            </li>
            <li className="page-item">
                <Link className="page-link" to="/calcas">2</Link>
            </li>
            <li className="page-item-selected">
                <Link className="page-link" to="/calcas">3</Link>
            </li>
            <li className="page-item">
                <Link className="page-link" to="/calcas">4</Link>
            </li>
            <li className="page-item">
                <Link className="page-link" to="/calcas">5</Link>
            </li>
            <li className="page-item">
                <Link className="page-link" to="/calcas">{`>`}</Link>
            </li>
        </ul>
    </nav>  
</div>
