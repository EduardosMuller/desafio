 ...
 //aqui está buscando todos os produtos do banco de dados
    ...
    return (
        ...
        <div>
            ...
            <div>
                <h6 className="navegacao">Página Inicial <span> {`>`} </span> <span className="spanRed">Sapatos</span></h6>
            </div>
            <div className="main d-flex flex-row">
                <div className="navbarLateralSapatos w-100 col-3">
        ...
        <nav aria-label="Page navigation example">
            <ul className="pagination justify-content-center">
                <li className="page-item disabled">
                    <Link className="page-link" to="/sapatos" tabIndex="-1">{`<`}</Link>
                </li>
                <li className="page-item">
                    <Link className="page-link" to="/sapatos">1</Link>
                </li>
                <li className="page-item">
                    <Link className="page-link" to="/sapatos">2</Link>
                </li>
                <li className="page-item-selected">
                    <Link className="page-link" to="/sapatos">3</Link>
                </li>
                <li className="page-item">
                    <Link className="page-link" to="/sapatos">4</Link>
                </li>
                <li className="page-item">
                    <Link className="page-link" to="/sapatos">5</Link>
                </li>
                <li className="page-item">
                    <Link className="page-link" to="/sapatos">{`>`}</Link>
                </li>
            </ul>
        </nav>  
    </div>
